...
import {commentOnAPost, postToCommunity} from "../../../action/action";
...
const CommentOnPost = ({navigation, route}: RootStackScreenProps<'CommentOnPost'>) => {
    ...
    const {mutate, isLoading} = useMutation(['commentOnAPost'], commentOnAPost,

        {
            ...
            onSettled: () => {
                queryClient.invalidateQueries(['commentOnAPost']);
            }
