...
const GateTokenTransactions = ({navigation}:RootStackScreenProps<'GateTokenTransactions'>) => {
        ...
        <SafeAreaView style={[styles.safeArea, {
...

            {
                ...
                <FlashList
                    ...
                    data={transactions.data.filter((transact: { token: string; }) => transact.token === 'GATE')}
...
export default GateTokenTransactions;
