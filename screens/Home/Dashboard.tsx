...
import {getAllAdventure, getBadges, getUser} from "../../action/action";
        ...
        <SafeAreaView style={[styles.safeArea, {
            ...
            <ScrollView
                ...
                <View style={[styles.topDashboard, {
                    ...
                    {/*   */}
                    <Animated.View key={fullName} entering={FadeInUp} exiting={FadeOutDown}
...

                {
                    ...
                    <TouchableOpacity onPress={verifyPhone} style={[styles.verifyCard, {
                        ...
                        data?.pages[0]?.data?.result.map((({
                            ...
                            <Animated.View key={id} entering={FadeInDown} exiting={FadeOutDown}
                                ...
                                <Pressable onPress={() => goToAdventure(id, name, modules)}
                                    ...
                                    <Image source={{uri: imageUrl}} style={styles.adventureItemImage}/>
                                </Pressable>
                            </Animated.View>
                        )))
